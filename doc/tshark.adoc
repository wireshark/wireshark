...
+
--
Print timing information for each pass tshark does to process a capture
file, as a JSON array. The output contains the total elapsed time for
each pass and aggregate counters for per-packet operations, currently
dissection and filtering.
--
