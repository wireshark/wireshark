...
p_dissect_per_length_determinant = pat->p_dissect_per_length_determinant;
p_dissect_per_normally_small_nonnegative_whole_number = pat->p_dissect_per_normally_small_nonnegative_whole_number;
...
p_dissect_h225_TransportAddress = pat->p_dissect_h225_TransportAddress;
p_dissect_h245_NonStandardParameter = pat->p_dissect_h245_NonStandardParameter;
