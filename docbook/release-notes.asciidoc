...
// Unable to replicate
// * Wireshark stack corruption in ascii_strup_inplace (called by iseries_seek_next_packet). wsbuglink:15614[].
...
* LWM2M: resource with {backslash}r
 badly shown. wsbuglink:15572[].
