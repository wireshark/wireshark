...
// cp /dev/null /tmp/buglist.txt ; for bugnumber in `git log --stat v2.6.2rc0..| grep ' Bug:' | cut -f2 -d: | sort -n -u ` ; do ./tools/gen-bugnote $bugnumber; pbpaste >> /tmp/buglist.txt; done
