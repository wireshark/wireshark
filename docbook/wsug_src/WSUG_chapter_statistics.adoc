...
The Access Node Control Protocol (ANCP) is an TCP based protocol, which operates between an Access Node and Network Access Server. The ANCP window shows the related statistical data. The user can filter, copy or save the data into a file.
