...
QT_INIT_METAOBJECT const QMetaObject ExpertInfoProxyModel::staticMetaObject = { {
    &QSortFilterProxyModel::staticMetaObject,
    qt_meta_stringdata_ExpertInfoProxyModel.data,
    qt_meta_data_ExpertInfoProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
