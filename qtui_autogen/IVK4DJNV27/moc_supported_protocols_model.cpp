...
QT_INIT_METAOBJECT const QMetaObject SupportedProtocolsModel::staticMetaObject = { {
    &QAbstractItemModel::staticMetaObject,
    qt_meta_stringdata_SupportedProtocolsModel.data,
...
QT_INIT_METAOBJECT const QMetaObject SupportedProtocolsProxyModel::staticMetaObject = { {
    &QSortFilterProxyModel::staticMetaObject,
    qt_meta_stringdata_SupportedProtocolsProxyModel.data,
    qt_meta_data_SupportedProtocolsProxyModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
