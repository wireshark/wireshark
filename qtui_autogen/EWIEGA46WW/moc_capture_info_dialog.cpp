...
QT_INIT_METAOBJECT const QMetaObject CaptureInfoModel::staticMetaObject = { {
    &QAbstractTableModel::staticMetaObject,
    qt_meta_stringdata_CaptureInfoModel.data,
...
QT_INIT_METAOBJECT const QMetaObject CaptureInfoDialog::staticMetaObject = { {
    &GeometryStateDialog::staticMetaObject,
    qt_meta_stringdata_CaptureInfoDialog.data,
