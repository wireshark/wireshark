...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WiresharkDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_WiresharkDialog_t qt_meta_stringdata_WiresharkDialog = {
    {
QT_MOC_LITERAL(0, 0, 15), // "WiresharkDialog"
QT_MOC_LITERAL(1, 16, 12), // "captureEvent"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 12) // "CaptureEvent"
...
void WiresharkDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        WiresharkDialog *_t = static_cast<WiresharkDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject WiresharkDialog::staticMetaObject = { {
    &GeometryStateDialog::staticMetaObject,
    qt_meta_stringdata_WiresharkDialog.data,
