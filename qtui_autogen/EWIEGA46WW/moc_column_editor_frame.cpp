...
void ColumnEditorFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ColumnEditorFrame::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ColumnEditorFrame::pushFilterSyntaxStatus)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ColumnEditorFrame::staticMetaObject = { {
    &AccordionFrame::staticMetaObject,
    qt_meta_stringdata_ColumnEditorFrame.data,
