...
static const usb_ptp_value_string_masked_t usb_ptp_dpc_mvals[] = {
    ...
    {USB_PTP_FLAVOR_ALL       , 0xd001, "GP_SIGMA_FP_ShutterSpeed"},
    {USB_PTP_FLAVOR_SONY      , 0xd001, "IrisModeSetting"},
    ...
    {USB_PTP_FLAVOR_ALL       , 0xd004, "GP_SIGMA_FP_ISOSpeed"},
    {USB_PTP_FLAVOR_OLYMPUS   , 0xd004, "ExposureMeteringMode"},
    {USB_PTP_FLAVOR_SONY      , 0xd004, "FocalDistanceInMeter"},
    {USB_PTP_FLAVOR_CANON     , 0xd005, "CameraMode"},
    {USB_PTP_FLAVOR_CASIO     , 0xd005, "UNKNOWN_2"},
    {USB_PTP_FLAVOR_KODAK     , 0xd005, "PowerSaving"},
    {USB_PTP_FLAVOR_ALL       , 0xd005, "GP_SIGMA_FP_ExpCompensation"},
    {USB_PTP_FLAVOR_SONY      , 0xd005, "FocalDistanceInFeet"},
    {USB_PTP_FLAVOR_CANON     , 0xd006, "ImageQuality"},
    {USB_PTP_FLAVOR_KODAK     , 0xd006, "UI_Language"},
    {USB_PTP_FLAVOR_ALL       , 0xd006, "GP_SIGMA_FP_BatteryState"},
    {USB_PTP_FLAVOR_SONY      , 0xd006, "FocalDistanceUnitSetting"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd007, "FocusModeSetting"},
    ...
    {USB_PTP_FLAVOR_OLYMPUS   , 0xd00e, "ColorTemperature"},
    ...
    {USB_PTP_FLAVOR_OLYMPUS   , 0xd051, "AFArea"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0xd05d, "StillFocusMeteringMode"},
    {USB_PTP_FLAVOR_NIKON     , 0xd05e, "AELockMode"},
    {USB_PTP_FLAVOR_NIKON     , 0xd05f, "AELAFLMode"},
    {USB_PTP_FLAVOR_NIKON     , 0xd060, "IPTCPresetSelect"},
    {USB_PTP_FLAVOR_NIKON     , 0xd061, "LiveViewAFFocus"},
    {USB_PTP_FLAVOR_NIKON     , 0xd061, "StillFocusMode"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0xd0cd, "SaveFocusPosition"},
    {USB_PTP_FLAVOR_SONY      , 0xd0d9, "ImageStabilization"},
    {USB_PTP_FLAVOR_SONY      , 0xd0db, "SilentMode"},
    {USB_PTP_FLAVOR_OLYMPUS   , 0xd0dc, "CaptureTarget"},
    {USB_PTP_FLAVOR_SONY      , 0xd0df, "ShutterType"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0xd0f6, "StillCaptureModeQuick"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0xd119, "Slot2JpegImageSize"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0xd126, "StroboExpCompositionControl"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0xd12f, "AWBLockStatus"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd156, "ShutterLagTiming"},
    ...
    {USB_PTP_FLAVOR_OLYMPUS   , 0xd161, "WhiteBalanceAdjustA"},
    {USB_PTP_FLAVOR_CANON     , 0xd162, "PictureStyleUserSet3"},
    {USB_PTP_FLAVOR_FUJI      , 0xd162, "BCRAppendDelimiter"},
    {USB_PTP_FLAVOR_OLYMPUS   , 0xd162, "WhiteBalanceAdjustB"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0xd178, "HighISONoiseReduction"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0xd1c5, "AutoFlashIsoSensitivityControl"},
    {USB_PTP_FLAVOR_CANON     , 0xd1c6, "BuiltinStroboMode"},
    {USB_PTP_FLAVOR_NIKON     , 0xd1c6, "KeepExposureWhenFNumberChanges"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0xd1cb, "StroboExpComposition"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd20e, "BatteryLevelIndicator"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd217, "AELockIndication"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd21d, "MovieRecordingState"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd223, "DateTimeSet"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd227, "FormatMediaStatus"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd235, "ManualFocusAdjustEnableStatus"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xd239, "PixelShiftShootingMode2"},
    {USB_PTP_FLAVOR_NIKON     , 0xd23a, "MovieWhiteBalance"},
    {USB_PTP_FLAVOR_SONY      , 0xd23a, "PixelShiftShootingNumber"},
    {USB_PTP_FLAVOR_NIKON     , 0xd23b, "MovieActiveDLighting"},
    {USB_PTP_FLAVOR_SONY      , 0xd23b, "PixelShiftShootingInterval"},
    {USB_PTP_FLAVOR_NIKON     , 0xd23c, "MovieWbTuneNatural"},
    {USB_PTP_FLAVOR_SONY      , 0xd23c, "PixelShiftShootingStatus"},
    {USB_PTP_FLAVOR_NIKON     , 0xd23d, "MovieAttenuator"},
    {USB_PTP_FLAVOR_SONY      , 0xd23d, "PixelShiftShootingProgress"},
    {USB_PTP_FLAVOR_NIKON     , 0xd23e, "MovieVignetteControl"},
    {USB_PTP_FLAVOR_NIKON     , 0xd23f, "MovieDiffractionCompensation"},
    {USB_PTP_FLAVOR_SONY      , 0xd23f, "PictureProfile"},
    {USB_PTP_FLAVOR_FUJI      , 0xd240, "ShutterSpeed2"},
    {USB_PTP_FLAVOR_SONY      , 0xd240, "CreativeStyle"},
    {USB_PTP_FLAVOR_FUJI      , 0xd241, "ImageAspectRatio"},
    {USB_PTP_FLAVOR_NIKON     , 0xd241, "D241"},
    {USB_PTP_FLAVOR_SONY      , 0xd241, "FileFormatMovie"},
    {USB_PTP_FLAVOR_FUJI      , 0xd242, "BatteryLevel"},
    {USB_PTP_FLAVOR_SONY      , 0xd242, "RecordingSettingMovie"},
    {USB_PTP_FLAVOR_NIKON     , 0xd244, "D244"},
    {USB_PTP_FLAVOR_NIKON     , 0xd247, "D247"},
    {USB_PTP_FLAVOR_SONY      , 0xd248, "MediaSLOT1Status"},
    {USB_PTP_FLAVOR_SONY      , 0xd249, "MediaSLOT1RemainingShots"},
    {USB_PTP_FLAVOR_SONY      , 0xd24a, "MediaSLOT1ShootingTime"},
    {USB_PTP_FLAVOR_SONY      , 0xd24c, "FocalPosition"},
    {USB_PTP_FLAVOR_SONY      , 0xd24e, "AWBLockIndication"},
    {USB_PTP_FLAVOR_NIKON     , 0xd24f, "GUID"},
    {USB_PTP_FLAVOR_SONY      , 0xd24f, "IntervalRECModel"},
    {USB_PTP_FLAVOR_NIKON     , 0xd250, "D250"},
    {USB_PTP_FLAVOR_SONY      , 0xd250, "IntervalRECStatus"},
    {USB_PTP_FLAVOR_NIKON     , 0xd251, "D251"},
    {USB_PTP_FLAVOR_SONY      , 0xd251, "DeviceOverheatStatus"},
    {USB_PTP_FLAVOR_SONY      , 0xd252, "JpegQuality"},
    {USB_PTP_FLAVOR_SONY      , 0xd253, "CompressionSetting"},
    {USB_PTP_FLAVOR_SONY      , 0xd254, "FocusMagnifierSetting"},
    {USB_PTP_FLAVOR_SONY      , 0xd255, "AFTrackingSensitivity"},
    {USB_PTP_FLAVOR_SONY      , 0xd256, "MediaSLOT2Status"},
    {USB_PTP_FLAVOR_SONY      , 0xd257, "MediaSLOT2RemainingShots"},
    {USB_PTP_FLAVOR_SONY      , 0xd258, "MediaSLOT2ShootingTime"},
    {USB_PTP_FLAVOR_SONY      , 0xd25a, "PriorityMode"},
    {USB_PTP_FLAVOR_SONY      , 0xd25b, "ZoomEnableStatus"},
    {USB_PTP_FLAVOR_SONY      , 0xd25c, "ZoomScale"},
    {USB_PTP_FLAVOR_SONY      , 0xd25d, "ZoomBarInformation"},
    {USB_PTP_FLAVOR_SONY      , 0xd25e, "ZoomSpeedRange"},
    {USB_PTP_FLAVOR_SONY      , 0xd25f, "ZoomSetting"},
    {USB_PTP_FLAVOR_SONY      , 0xd260, "ZoomTypeStatus"},
    {USB_PTP_FLAVOR_SONY      , 0xd262, "WirelessFlashSetting"},
    {USB_PTP_FLAVOR_SONY      , 0xd263, "RedEyeReduction"},
    {USB_PTP_FLAVOR_SONY      , 0xd264, "RemoteControlRestrictionStatus"},
    {USB_PTP_FLAVOR_SONY      , 0xd267, "LiveViewArea"},
    {USB_PTP_FLAVOR_SONY      , 0xd268, "PcSaveImageSize"},
    {USB_PTP_FLAVOR_SONY      , 0xd269, "PcSaveImageFormat"},
    {USB_PTP_FLAVOR_SONY      , 0xd26a, "LiveViewImageQuality"},
    {USB_PTP_FLAVOR_SONY      , 0xd26b, "CustomWBCaptureArea"},
    {USB_PTP_FLAVOR_SONY      , 0xd26c, "CustomWBCaptureFrameSize"},
    {USB_PTP_FLAVOR_SONY      , 0xd26d, "CustomWBCaptureStandbyEnable"},
    {USB_PTP_FLAVOR_SONY      , 0xd26e, "CustomWBCaptureStandbyCancelEnable"},
    {USB_PTP_FLAVOR_SONY      , 0xd26f, "CustomWBCaptureEnable"},
    {USB_PTP_FLAVOR_SONY      , 0xd270, "CustomWBExecutionState"},
    {USB_PTP_FLAVOR_SONY      , 0xd271, "SettingsSaveEnable"},
    {USB_PTP_FLAVOR_SONY      , 0xd272, "SettingsReadEnable"},
    {USB_PTP_FLAVOR_SONY      , 0xd273, "SettingsSaveReadState"},
    {USB_PTP_FLAVOR_SONY      , 0xd274, "FTPSettingSaveEnable"},
    {USB_PTP_FLAVOR_SONY      , 0xd275, "FTPSettingReadEnable"},
    {USB_PTP_FLAVOR_SONY      , 0xd276, "FTPSettingSaveReadState"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c1, "ShutterHalfRelease"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c2, "ShutterRelease"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c3, "AELButton"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c4, "AFLButton"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c5, "ReleaseLock"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c7, "RequestOneShooting"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c8, "MovieRecButtonHold"},
    {USB_PTP_FLAVOR_SONY      , 0xd2c9, "FELButton"},
    {USB_PTP_FLAVOR_SONY      , 0xd2ca, "FormatMedia"},
    {USB_PTP_FLAVOR_SONY      , 0xd2cb, "FocusMagnifier"},
    {USB_PTP_FLAVOR_SONY      , 0xd2cc, "FocusMagnifierCancel"},
    {USB_PTP_FLAVOR_SONY      , 0xd2cd, "RemoteKeyUp"},
    {USB_PTP_FLAVOR_SONY      , 0xd2ce, "RemoteKeyDown"},
    {USB_PTP_FLAVOR_SONY      , 0xd2cf, "RemoteKeyLeft"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d0, "RemoteKeyRight"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d1, "ManualFocusAdjust"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d2, "AFMFHold"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d3, "CancelPixelShiftShooting"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d4, "PixelShiftShootingMode"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d5, "HFRStandby"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d6, "HFRRecordingCancel"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d7, "FocusStepNear"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d8, "FocusStepFar"},
    {USB_PTP_FLAVOR_SONY      , 0xd2d9, "AWBLButton"},
    {USB_PTP_FLAVOR_SONY      , 0xd2dc, "AFAreaPosition"},
    {USB_PTP_FLAVOR_SONY      , 0xd2dd, "ZoomOperation"},
    {USB_PTP_FLAVOR_SONY      , 0xd2df, "CustomWBCaptureStandby"},
    {USB_PTP_FLAVOR_SONY      , 0xd2e0, "CustomWBCaptureStandbyCancel"},
    {USB_PTP_FLAVOR_SONY      , 0xd2e1, "CustomWBCapture"},
    {USB_PTP_FLAVOR_SONY      , 0xd2e2, "FormatMediaCard"},
    {USB_PTP_FLAVOR_SONY      , 0xd2e4, "RemoteTouch"},
    {USB_PTP_FLAVOR_SONY      , 0xd2e5, "RemoteTouchCancel"},
    {USB_PTP_FLAVOR_SONY      , 0xd2e9, "SaveZoomAndFocusPosition"},
    {USB_PTP_FLAVOR_SONY      , 0xd2ea, "LoadZoomAndFocusPosition"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0x1d000, "MovieProResToneMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d001, "MovieH265ToneMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d002, "SpecialShootingMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d005, "AFSubjectDetection"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d006, "MovieAFSubjectDetection"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d007, "ViewModeEaseOfViewing"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d008, "ViewModeWhiteBalance"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d009, "ViewModeWbColorTemp"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d00a, "ViewModeWbTuneColorTemp"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d00b, "ViewModePictureControl"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d00c, "ViewModeBrightenShadow"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d00e, "StarlightView"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d00f, "MovieTVLockSetting"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d010, "MovieAVLockSetting"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d011, "SilentMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d012, "ShutterSoundEffect"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d014, "AFWhenSubjectNotDetected"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d015, "FocusPointLock"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d016, "MovieFocusPointLock"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d017, "SkinSoftening"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d018, "MovieSkinSoftening"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d019, "PortraitImpressionBalance"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d01a, "MoviePortraitImpressionBalance"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d01b, "MovieExtendedShutterSpeedsManual"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d01c, "ToneMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d01d, "ActivePicCtrlHlgItem"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d01e, "ExtendOverSampling"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d01f, "MovieExtendIsoStepManual"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d025, "PreCapturePreReleaseBurst"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d026, "PreCapturePostReleaseBurst"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d028, "MovieNRaw12bitToneMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d029, "MovieProResRawHq12bitToneMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d029, "MovieQualityNRaw"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d031, "HighFrequencyFlickerReduction"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d032, "MovieHighFrequencyFlickerReduction"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d033, "HiResZoom"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d036, "ViewModeShowEffectsOfSettings"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d03d, "FlickerReductionShutterSpeed"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d041, "EnableDXImageSize"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d042, "ImageSizeDX"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d045, "PixelShiftShootingMode"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d046, "WideAreaAFC1"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d047, "WideAreaAFC2"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d048, "MovieWideAreaAFC1"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d049, "MovieWideAreaAFC2"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d04a, "FmmManualSetting2"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d04b, "F0ManualSetting2"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d04c, "ManualSettingLensName"},
    {USB_PTP_FLAVOR_NIKON     , 0x1d050, "PixelShiftShootingInterval"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000010, "PhotoStyle"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000020, "ISO"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000021, "ISO_Param"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000022, "ISO_UpperLimit"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000030, "ShutterSpeed"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000031, "ShutterSpeed_Param"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000032, "ShutterSpeed_RangeLimit"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000040, "Aperture"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000041, "Aperture_Param"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000042, "Aperture_RangeLimit"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000050, "WhiteBalance"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000051, "WhiteBalance_Param"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000052, "WhiteBalance_KSet"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000053, "WhiteBalance_ADJ_AB"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000054, "WhiteBalance_ADJ_GM"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000055, "WhiteBalance_ADJ_AB_Sep"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000060, "Exposure"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000061, "Exposure_Param"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000062, "Exposure_RangeLimit"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000070, "AFArea"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000071, "AFArea_AFModeParam"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000072, "AFArea_AFAreaParam"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000073, "AFArea_SetQuickAFParam"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000080, "CameraMode"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000081, "CameraMode_DriveMode"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000082, "CameraMode_ModePos"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000083, "CameraMode_CreativeMode"},
    {USB_PTP_FLAVOR_PANASONIC , 0x02000084, "CameraMode_iAMode"},
    ...
    {USB_PTP_FLAVOR_PANASONIC , 0x03000010, "RecCtrlRelease"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03000020, "RecCtrlAFAE"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03000021, "RecCtrlAFAE_LockAE"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03000022, "RecCtrlAFAE_LockAF"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03000023, "RecCtrlAFAE_LockAFAE"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03000024, "RecCtrlAFAE_AF_OneShot"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03000025, "RecCtrlAFAE_Lock_Clear"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03000080, "Zoom"},
    {USB_PTP_FLAVOR_PANASONIC , 0x03010010, "RecCtrlLens"},
    {USB_PTP_FLAVOR_PANASONIC , 0x06000010, "MovConfig"},
    {USB_PTP_FLAVOR_PANASONIC , 0x06000011, "MovConfig_C_Movie_Mode"},
    {USB_PTP_FLAVOR_PANASONIC , 0x06000012, "MovConfig_HDMI_Mode"},
    {USB_PTP_FLAVOR_PANASONIC , 0x06000013, "MovConfig_Quality_Mode"},
    {USB_PTP_FLAVOR_PANASONIC , 0x06000014, "MovConfig_Rec_Mode"},
...
static const usb_ptp_value_string_masked_t usb_ptp_ec_mvals[] = {
    ...
    {USB_PTP_FLAVOR_CANON     , 0xc1b5, "HiFreqFlickerlessAutodetectResult"},
    {USB_PTP_FLAVOR_CANON     , 0xc1b6, "ObjectAddedEx64LFN"},
    {USB_PTP_FLAVOR_CANON     , 0xc1b7, "ObjectInfoChangedEx64LFN"},
    {USB_PTP_FLAVOR_CANON     , 0xc1b8, "RequestObjectTransfer64LFN"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0xc203, "DevicePropChanged"},
    {USB_PTP_FLAVOR_SONY      , 0xc206, "CapturedEvent"},
    {USB_PTP_FLAVOR_SONY      , 0xc208, "CWBCaptureResult"},
    {USB_PTP_FLAVOR_SONY      , 0xc209, "CameraSettingReadResult"},
    {USB_PTP_FLAVOR_SONY      , 0xc20a, "FTPSettingReadResult"},
    {USB_PTP_FLAVOR_SONY      , 0xc20b, "MediaFormatResult"},
    {USB_PTP_FLAVOR_SONY      , 0xc20c, "FTPDisplayNameListChanged"},
    {USB_PTP_FLAVOR_SONY      , 0xc20d, "ContentsTransferEvent"},
    {USB_PTP_FLAVOR_SONY      , 0xc20f, "DisplayListChangedEvent"},
    {USB_PTP_FLAVOR_SONY      , 0xc218, "FocusPositionResult"},
    {USB_PTP_FLAVOR_SONY      , 0xc21b, "LensInformationChanged"},
    {USB_PTP_FLAVOR_SONY      , 0xc222, "OperationResult"},
    {USB_PTP_FLAVOR_SONY      , 0xc223, "AFStatus"},
    {USB_PTP_FLAVOR_SONY      , 0xc224, "MovieRecOperationsResult"},
...
static const usb_ptp_value_string_masked_t usb_ptp_oc_mvals[] = {
    ...
    {USB_PTP_FLAVOR_ALL       , 0x9020, "SIGMA_FP_GetPictFileInfo"},
    ...
    {USB_PTP_FLAVOR_ALL       , 0x9021, "SIGMA_FP_GetPartialPictFile"},
    ...
    {USB_PTP_FLAVOR_ALL       , 0x9022, "SIGMA_FP_GetBigPartialPictFile"},
    {USB_PTP_FLAVOR_CANON     , 0x9023, "TerminateDirectTransfer"},
    {USB_PTP_FLAVOR_ALL       , 0x9023, "SIGMA_FP_GetDataGroup4"},
    ...
    {USB_PTP_FLAVOR_ALL       , 0x9024, "SIGMA_FP_SetDataGroup4"},
    ...
    {USB_PTP_FLAVOR_ALL       , 0x9025, "SIGMA_FP_GetCamSentInfo2"},
    ...
    {USB_PTP_FLAVOR_ALL       , 0x9026, "SIGMA_FP_GetCamSentInfo3"},
    ...
    {USB_PTP_FLAVOR_ALL       , 0x9030, "SIGMA_FP_GetCamCanSetInfo5"},
    {USB_PTP_FLAVOR_CANON     , 0x9031, "GetPairingInfo"},
    {USB_PTP_FLAVOR_LEICA     , 0x9031, "CloseLiveViewSession"},
    {USB_PTP_FLAVOR_ALL       , 0x9031, "SIGMA_FP_GetCamDataGroupFocus"},
    {USB_PTP_FLAVOR_CANON     , 0x9032, "DeletePairingInfo"},
    {USB_PTP_FLAVOR_ALL       , 0x9032, "SIGMA_FP_SetCamDataGroupFocus"},
    {USB_PTP_FLAVOR_CANON     , 0x9033, "GetMACAddress"},
    {USB_PTP_FLAVOR_ALL       , 0x9033, "SIGMA_FP_GetCamDataGroupMovie"},
    {USB_PTP_FLAVOR_CANON     , 0x9034, "SetDisplayMonitor"},
    {USB_PTP_FLAVOR_ALL       , 0x9034, "SIGMA_FP_SetCamDataGroupMovie"},
    {USB_PTP_FLAVOR_CANON     , 0x9035, "PairingComplete"},
    {USB_PTP_FLAVOR_ALL       , 0x9035, "SIGMA_FP_GetCameraInfo"},
    {USB_PTP_FLAVOR_CANON     , 0x9036, "GetWirelessMAXChannel"},
    {USB_PTP_FLAVOR_LEICA     , 0x9036, "LESetDateTime"},
    {USB_PTP_FLAVOR_ALL       , 0x9036, "SIGMA_FP_GetMovieFileInfo"},
    {USB_PTP_FLAVOR_LEICA     , 0x9037, "GetObjectPropListPaginated"},
    {USB_PTP_FLAVOR_ALL       , 0x9037, "SIGMA_FP_GetPartialMovieFile"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0x9087, "GetDebugLog"},
    {USB_PTP_FLAVOR_CANON     , 0x9088, "SetModeDialDisable"},
    {USB_PTP_FLAVOR_CANON     , 0x9089, "Clear_CCAPI_UsageCount"},
    {USB_PTP_FLAVOR_CANON     , 0x908a, "SetMetaProperty"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0x9166, "SetManipulationToggleImageSide"},
    {USB_PTP_FLAVOR_CANON     , 0x9167, "GetLensSerialNumHistory"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0x917b, "SetRemoteErrLogMode"},
    {USB_PTP_FLAVOR_CANON     , 0x917c, "GetRemoteErrLogMode"},
    {USB_PTP_FLAVOR_CANON     , 0x917d, "GetDebugLogEx"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0x91b1, "SendWifiSetting"},
    {USB_PTP_FLAVOR_CANON     , 0x91b2, "SendWifiDetailSetting"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0x9200, "EdgeFocusPosition"},
    {USB_PTP_FLAVOR_NIKON     , 0x9200, "GetPreviewImg"},
    {USB_PTP_FLAVOR_CANON     , 0x9201, "DriveFocusToEdge"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0x9201, "SDIO_Connect"},
    {USB_PTP_FLAVOR_CANON     , 0x9202, "DriveFocus"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0x9202, "SDIO_GetExtDeviceInfo"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0x9205, "SDIO_SetExtDevicePropValue"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0x9207, "SDIO_ControlDevice"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0x9209, "SDIO_GetAllExtDevicePropInfo"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0x9210, "SDIO_OpenSession"},
    {USB_PTP_FLAVOR_PARROT    , 0x9211, "StopMagnetoCalib"},
    {USB_PTP_FLAVOR_SONY      , 0x9211, "SDIO_GetPartialLargeObject"},
    {USB_PTP_FLAVOR_MTP       , 0x9212, "WMDRMPD_SendWMDRMPDAppRequest"},
    {USB_PTP_FLAVOR_PARROT    , 0x9212, "MagnetoCalibStatus"},
    {USB_PTP_FLAVOR_SONY      , 0x9212, "SDIO_SetContentsTransferMode"},
    ...
    {USB_PTP_FLAVOR_SONY      , 0x9215, "SDIO_GetDisplayStringList"},
    {USB_PTP_FLAVOR_MTP       , 0x9216, "WMDRMPD_EndTrustedAppSession"},
    {USB_PTP_FLAVOR_SONY      , 0x9223, "SDIO_GetLensInformation"},
    {USB_PTP_FLAVOR_SONY      , 0x922f, "SDIO_OperationsResultsSupported"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0x9401, "DV_Get_WavInfo"},
    {USB_PTP_FLAVOR_PANASONIC , 0x9401, "9401"},
    {USB_PTP_FLAVOR_CANON     , 0x9402, "DV_Overwrite_Contents_XML"},
    ...
    {USB_PTP_FLAVOR_CANON     , 0x9403, "DV_Get_Template_XML"},
    ...
    {USB_PTP_FLAVOR_PANASONIC , 0x940a, "GetCaptureTarget"},
    {USB_PTP_FLAVOR_PANASONIC , 0x940b, "SetCaptureTarget"},
    {USB_PTP_FLAVOR_NIKON     , 0x940c, "CancelImagesInSDRAM"},
    {USB_PTP_FLAVOR_PANASONIC , 0x940c, "MovieRecControl"},
    ...
    {USB_PTP_FLAVOR_PANASONIC , 0x9414, "GetLiveViewParameters"},
    {USB_PTP_FLAVOR_PANASONIC , 0x9414, "PollEvents"},
    {USB_PTP_FLAVOR_NIKON     , 0x9415, "GetSBAttrDesc"},
    {USB_PTP_FLAVOR_PANASONIC , 0x9415, "SetLiveViewParameters"},
    ...
    {USB_PTP_FLAVOR_NIKON     , 0x9439, "GetVendorCodes"},
...
static const usb_ptp_value_string_masked_t usb_ptp_ofc_mvals[] = {
    ...
    {USB_PTP_FLAVOR_SONY      , 0xb301, "MPO"},
...
static const usb_ptp_value_string_masked_t usb_ptp_rc_mvals[] = {
    ...
    {USB_PTP_FLAVOR_SONY      , 0xa101, "AuthenticationFailed"},
    {USB_PTP_FLAVOR_CANON     , 0xa102, "ObjectNotReady"},
    {USB_PTP_FLAVOR_CANON     , 0xa102, "NOT_READY"},
    {USB_PTP_FLAVOR_SONY      , 0xa102, "PasswordLengthOverMax"},
    {USB_PTP_FLAVOR_SONY      , 0xa103, "PasswordIncludesInvalidChar"},
    {USB_PTP_FLAVOR_CANON     , 0xa104, "CannotMakeObject"},
    {USB_PTP_FLAVOR_SONY      , 0xa104, "FeatureVersionInvalidValue"},
    {USB_PTP_FLAVOR_SONY      , 0xa105, "TemporaryStorageFull"},
    {USB_PTP_FLAVOR_CANON     , 0xa106, "MemoryStatusNotReady"},
    {USB_PTP_FLAVOR_SONY      , 0xa106, "CameraStatusError"},
