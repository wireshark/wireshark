...
#line 1 "./asn1/xnap/packet-xnap-hfarr.c"
    ...
    { &hf_xnap_tac,
      { "tac", "xnap.tac",
        ...
        NULL, HFILL }},
    { &hf_xnap_e_utraCI,
      { "e-utraCI", "xnap.E-UTRA-Cell-Identity",
