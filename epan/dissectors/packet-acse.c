...
#line 81 "../../asn1/acse/acse.cnf"
  ...
  if((oid = find_oid_by_pres_ctx_id(actx->pinfo, indir_ref)) != NULL) {
    actx->external.direct_reference = ep_strdup(oid);
...
#line 103 "../../asn1/acse/acse.cnf"
  if (actx->external.direct_ref_present) {
    offset=call_ber_oid_callback(actx->external.direct_reference, tvb, offset, actx->pinfo, top_tree ? top_tree : tree);
  }
...
#line 53 "../../asn1/acse/acse.cnf"
  if (actx->external.direct_ref_present) {
    offset=call_ber_oid_callback(actx->external.direct_reference, tvb, offset, actx->pinfo, top_tree);
  }
