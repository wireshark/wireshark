...
const value_string EVsipConfigItem_vals[] =
{
   ...
   {4097, "CONFIG_VIDEO_ATTRIBUT_BRIGHTNESS"},
   {4098, "CONFIG_VIDEO_ATTRIBUT_CONTRAST"},
   {4099, "CONFIG_VIDEO_ATTRIBUT_GAIN_U"},
   {4100, "CONFIG_VIDEO_ATTRIBUT_GAIN_V"},
   {4101, "CONFIG_VIDEO_ATTRIBUT_HUE"},
   {4102, "CONFIG_VIDEO_ATTRIBUT_MOTION_ENC"},
   {4103, "CONFIG_VIDEO_ATTRIBUT_SATURATION"},
   ...
   {57345, "CONFIG_OSD_DEBUG_DISPLAY_LOGO"},
