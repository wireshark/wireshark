...
#line 1 "packet-x2ap-hfarr.c"
    ...
    { &hf_x2ap_PrivateIE_Container_item,
      { "PrivateIE-Container", "x2ap.PrivateIE_Container_item",
        FT_NONE, BASE_NONE, NULL, 0,
    ...
    { &hf_x2ap_ForbiddenTAIs_item,
      { "ForbiddenTAIs", "x2ap.ForbiddenTAIs_item",
        FT_BYTES, BASE_HEX, NULL, 0,
        "x2ap.TAI", HFILL }},
    ...
    { &hf_x2ap_PDCP_SNofULSDUsNotToBeRetransmitted_List_item,
      { "PDCP-SNofULSDUsNotToBeRetransmitted-List", "x2ap.PDCP_SNofULSDUsNotToBeRetransmitted_List_item",
        FT_INT32, BASE_DEC, NULL, 0,
        "x2ap.PDCP_SN", HFILL }},
