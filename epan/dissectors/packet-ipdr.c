...
proto_register_ipdr(void)
{
    static hf_register_info hf[] = {
        ...
        { &hf_ipdr_cm_ipv6_addr_string, { "CM IPv6 Address", "ipdr.cm_ipv6_addr", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL } },
        ...
        { &hf_ipdr_cm_ipv6_ll_addr_string, { "CM IPv6 Link-local Address", "ipdr.cm_ipv6_addr", FT_STRING, BASE_NONE, NULL, 0x0, NULL, HFILL } },
