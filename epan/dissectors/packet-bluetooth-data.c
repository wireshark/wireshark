...
const btatt_handle_strings_t btatt_handle_strings[] = {
    ...
    { 0xfc8c,   "Bluetooth GATT Attribute SES-Imagotag (UUID 0xfc8c)", "BT GATT SES-Imagotag (UUID 0xfc8c)", "btgatt.uuid0xfc8c" },
    ...
    { 0xfc9a,   "Bluetooth GATT Attribute Plockat Solutions AB (UUID 0xfc9a)", "BT GATT Plockat Solutions AB (UUID 0xfc9a)", "btgatt.uuid0xfc9a" },
    ...
    { 0xfc9c,   "Bluetooth GATT Attribute Binary Power, Inc. (UUID 0xfc9c)", "BT GATT Binary Power, Inc. (UUID 0xfc9c)", "btgatt.uuid0xfc9c" },
    ...
    { 0xfd8f,   "Bluetooth GATT Attribute Matrix ComSec Pvt. Ltd. (UUID 0xfd8f)", "BT GATT Matrix ComSec Pvt. Ltd. (UUID 0xfd8f)", "btgatt.uuid0xfd8f" },
    ...
    { 0xfdb9,   "Bluetooth GATT Attribute Comcast Cable Corporation (UUID 0xfdb9)", "BT GATT Comcast Cable Corporation (UUID 0xfdb9)", "btgatt.uuid0xfdb9" },
    { 0xfdba,   "Bluetooth GATT Attribute Comcast Cable Corporation (UUID 0xfdba)", "BT GATT Comcast Cable Corporation (UUID 0xfdba)", "btgatt.uuid0xfdba" },
    ...
    { 0xfe37,   "Bluetooth GATT Attribute Spaceek LTD (UUID 0xfe37)", "BT GATT Spaceek LTD (UUID 0xfe37)", "btgatt.uuid0xfe37" },
    { 0xfe38,   "Bluetooth GATT Attribute Spaceek LTD (UUID 0xfe38)", "BT GATT Spaceek LTD (UUID 0xfe38)", "btgatt.uuid0xfe38" },
    ...
    { 0xfea1,   "Bluetooth GATT Attribute Intrepid Control Systems, Inc. (UUID 0xfea1)", "BT GATT Intrepid Control Systems, Inc. (UUID 0xfea1)", "btgatt.uuid0xfea1" },
    { 0xfea2,   "Bluetooth GATT Attribute Intrepid Control Systems, Inc. (UUID 0xfea2)", "BT GATT Intrepid Control Systems, Inc. (UUID 0xfea2)", "btgatt.uuid0xfea2" },
    ...
    { 0xfedf,   "Bluetooth GATT Attribute Design SHIFT (UUID 0xfedf)", "BT GATT Design SHIFT (UUID 0xfedf)", "btgatt.uuid0xfedf" },
