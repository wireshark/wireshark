...
/*  193*/ DEF_VALS2(MQIA_BASE_TYPE               ,GET_VALSP(BaseType)),
...
/* 1575*/ DEF_VALS2(MQIACH_HDR_COMPRESSION       ,GET_VALSP(HeaderCompression)),
/* 1576*/ DEF_VALS2(MQIACH_MSG_COMPRESSION       ,GET_VALSP(MessageCompression)),
