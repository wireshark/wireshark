...
DEF_VALSBX(mqrc)
    ...
    DEF_VALS2(MQRCCF_MODE_VALUE_ERROR,"MQRCCF_MODE_VALUE_ERROR/MQRCCF_QUIESCE_VALUE_ERROR"),
...
DEF_VALSBX(MQCFINT_Parse)
    ...
    DEF_VALS2(MQIACF_Q_MGR_STATUS          ,GET_VALSP(QSGStatus)),
    ...
    DEF_VALS2(MQIA_APPL_TYPE               ,GET_VALSP(mqat)),
