...
/* IDL: 	uint32 length; */
/* IDL: 	uint32 size; */
/* IDL: 	[unique(1)] [length_is(length)] [size_is(size)] uint8 *spotlight_blob; */
/* IDL: } */
...
/* IDL: [out] [in] [ref] uint32 *device_id, */
/* IDL: [out] [in] [ref] uint32 *unkn2, */
/* IDL: [out] [in] [ref] uint32 *unkn3, */
/* IDL: [in] [charset(UTF8)] uint8 share_mount_path[*], */
/* IDL: [in] [charset(UTF8)] uint8 share_name[*], */
/* IDL: [out] [charset(UTF8)] [size_is(1025)] uint8 share_path[*], */
