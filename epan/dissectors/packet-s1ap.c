...
#line 360 "./asn1/s1ap/packet-s1ap-template.c"
  } else {
    if (SctpPort != 0) {
...
#line 519 "./asn1/s1ap/packet-s1ap-template.c"
  };
...
#line 553 "./asn1/s1ap/packet-s1ap-template.c"
  };
