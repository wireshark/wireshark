...
#line 368 "./asn1/s1ap/packet-s1ap-template.c"
...
#line 487 "./asn1/s1ap/packet-s1ap-template.c"
  } else {
    if (SctpPort != 0) {
...
#line 698 "./asn1/s1ap/packet-s1ap-template.c"
  };
...
#line 736 "./asn1/s1ap/packet-s1ap-template.c"
  };
