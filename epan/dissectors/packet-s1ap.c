...
#line 356 "./asn1/s1ap/packet-s1ap-template.c"
...
#line 475 "./asn1/s1ap/packet-s1ap-template.c"
  } else {
    if (SctpPort != 0) {
...
#line 678 "./asn1/s1ap/packet-s1ap-template.c"
  };
...
#line 715 "./asn1/s1ap/packet-s1ap-template.c"
  };
