 ...
 *
 * References: 3GPP TS 36.413 V13.4.0 (2016-09)
 */
...
#line 456 "./asn1/s1ap/packet-s1ap-template.c"
  } else {
    if (SctpPort != 0) {
...
#line 615 "./asn1/s1ap/packet-s1ap-template.c"
  };
...
#line 649 "./asn1/s1ap/packet-s1ap-template.c"
  };
