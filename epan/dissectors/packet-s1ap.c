...
#line 150 "./asn1/s1ap/packet-s1ap-template.c"
...
#line 357 "./asn1/s1ap/packet-s1ap-template.c"
...
#line 476 "./asn1/s1ap/packet-s1ap-template.c"
  } else {
    if (SctpPort != 0) {
...
#line 679 "./asn1/s1ap/packet-s1ap-template.c"
  };
