...
#define NUM_INDIVIDUAL_ELEMS_PFCP    53
    ...
    ett[47] = &ett_pfcp_adf;
    ett[48] = &ett_pfcp_aurl;
    ett[49] = &ett_pfcp_adnp;
    ett[50] = &ett_pfcp_pfcpsrreq;
    ett[51] = &ett_pfcp_pfcpaureq;
    ett[52] = &ett_pfcp_alternative_smf_ip_address_flags;
