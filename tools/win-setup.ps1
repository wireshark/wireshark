...
.EXAMPLE
C:\PS> .\tools\win-setup.ps1 -Destination C:\wireshark-win64-libs-3.2 -Platform win64
#>

Param(
    [Parameter(Mandatory=$true, Position=0)]
    [ValidateScript({$_ -like "*\wireshark-*-libs-3.2"})]
    [String]
    $Destination,
...
$Win64CurrentTag = "2020-04-08"
$Win32CurrentTag = "2020-04-08"
...
$Win32Files = @{
    "npcap-0.9989.exe" = "0a9b48be46833b067671bbbb240f8536bd6abe655511e90e9f3186ac0e9b6975";
