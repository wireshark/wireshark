...
$X64Archives = @{
    ...
    "libgcrypt/libgcrypt-bundle-1.12.2-1-x64-mingw-dynamic-ws.7z" = "0d6105c890314977c8c286f635113d9b5bf546e04440437da2ad3e4da0748e9e";
...
$Arm64Archives = @{
    ...
    "libgcrypt/libgcrypt-bundle-1.12.2-1-arm64-mingw-dynamic-ws.7z" = "f24918b2830ad49252e7263d23abee5c9715b0003499a94880f84c0d7143db4f";
