...
$X64Archives = @{
    ...
    "libssh/libssh-0.12.2-1-x64-mingw-dynamic-ws.7z" = "e17f22770bb0992870f51381b3e25d528541735c9602ee13e487324ceb456ac8";
...
$Arm64Archives = @{
    ...
    "libssh/libssh-0.12.2-1-arm64-mingw-dynamic-ws.7z" = "06a81338e9d66dab6659658fcf0d99508bfe1ccabda2e20b04bd498ba17e11d6";
