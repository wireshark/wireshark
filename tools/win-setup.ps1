...
$X64Archives = @{
    ...
    "spandsp/spandsp-0.0.6-4-x64-windows-ws.zip" = "01ff08b33638031417b32a9e87596a7696c0bd1a54f44143c49aee66f634d082";
...
$Arm64Archives = @{
    ...
    "spandsp/spandsp-0.0.6-4-arm64-windows-ws.zip" = "8dd0e29a54046f494d6714a8e52e32e07c9842dc5f8fadd72e65d231de14763a";
