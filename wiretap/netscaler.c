...
#define __TNO(enumprefix,structprefix,structname,hdrname,structfieldname) \
	guint8 enumprefix##_##hdrname##_offset = (guint8)(guint32)myoffsetof(nspr_##structname##_t,structprefix##_##structfieldname);
...
#define __TNV1O(enumprefix,structprefix,structname,hdrname,structfieldname) \
	guint8 enumprefix##_##hdrname##_offset = (guint8)(guint32)myoffsetof(nspr_##structname##_t,structfieldname);
