 ...
 *
 * $Id: packet-ncp-int.h,v 1.6.2.4 2002/02/27 05:08:49 gram Exp $
 *
...
struct _ptvc_record {
	...
	unsigned int	var_index	: 2; /* 3 = None */
	unsigned int	repeat_index	: 2; /* 3 = None */
	unsigned int	req_cond_index	: 6; /* 63 = None */
};
