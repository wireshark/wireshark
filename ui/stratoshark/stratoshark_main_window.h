...
/**
 * @brief Stratoshark main application window, extending MainWindow with
 *        Stratoshark-specific menus, toolbars, capture session management,
...
public:
    /**
     * @brief Constructs the Stratoshark main window and initialises all menus,
...
private:
    ...
    Ui::StratosharkMainWindow *main_ui_;          /**< Qt Designer-generated UI object. */
...
public slots:
     ...
     */
    void captureCaptureFixedFinished(capture_session *);
...
private slots:
    ...
    // in main_window_slots.cpp
    /**
     * @brief Start capturing from the selected interfaces using the capture filter
     ...
     * @param prepare    @c true if the filter should be prepared but not applied; @c false to apply immediately.
     */
