 ...
 * @param filter Filter string for packet selection.
 */
...
/**
 * @brief Register SRT tables for conversation tracking.
 *
...
/**
 * @brief Register RTD tables for conversation tracking.
 *
 * @param key Pointer to the key for the table.
 * @param value Pointer to the value for the table.
 * @param userdata Pointer to user data.
...
/**
 * @brief Register simple statistic tables for conversation tracking.
 *
 * @param key Pointer to the key for the table.
 * @param value Pointer to the value for the table.
 * @param userdata Pointer to user data.
